...
* O backup e a recuperação do BlueXP  não fazem backup de volumes em storage de objetos que tenham a criptografia de volume NetApp (NVE) habilitada e a criptografia agregada do NetApp (NAE) habilitada no ONTAP.
+
