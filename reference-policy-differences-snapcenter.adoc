...
Com o SnapCenter, você pode ter vários valores de retenção em várias políticas anexadas a um recurso.  No entanto, o BlueXP backup and recovery oferecem suporte apenas a um único valor de retenção para todas as políticas anexadas a um recurso.
